...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnJugar->setGeometry(QRect(280, 90, 80, 24));
        btnConfiguracion = new QPushButton(centralwidget);
        btnConfiguracion->setObjectName("btnConfiguracion");
        btnConfiguracion->setGeometry(QRect(280, 130, 80, 24));
        btnSalir = new QPushButton(centralwidget);
        btnSalir->setObjectName("btnSalir");
        btnSalir->setGeometry(QRect(280, 170, 80, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnConfiguracion->setText(QCoreApplication::translate("MainWindow", "AJUSTES", nullptr));
